...
class AIProvider:
    ...
    def extract_entities(text: str) -> List[Dict[str, Any]]:
        ...
        return [
            {"name": "Vikramaditya @ Vicky Kashi", "type": "person", "confidence": 0.98},
            {"name": "Rahul Kumar @ Munim", "type": "person", "confidence": 0.97},
            {"name": "Axis Bank A/C #91828400192", "type": "account", "confidence": 0.99},
            {"name": "Kashi Bullion Traders", "type": "organization", "confidence": 0.96},
